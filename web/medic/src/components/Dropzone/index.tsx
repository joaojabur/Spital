      ...
      if (file) {
        return (
          <p style={{ color: "#78e5d5" }}>
            Você selecionou o arquivo {file.name}
          </p>
        );
      }
      return (
        <p style={{ color: "#999" }}>
          Clique para selecionar sua foto de perfil ou arraste-a para a caixa.
        </p>
      );
    }
      ...
      {({ getRootProps, getInputProps, isDragActive, isDragReject }) => (
        <div
          ...
          className={`drop-container ${
            isDragActive ? "drop-container-drag-active" : ""
          } ${isDragReject ? "drop-container-drag-rejected" : ""} ${
